import * as core from "../src/set.core.js";
import * as common from "../src/set.common.js";
import * as numbers from "../src/set.numbers.js";
describe('Test empty set', () => {
  it('should test empty set', () => {
    expect(common.empty()(7)).toBeFalsy();
  });
});
describe('Test set all', () => {
  it('should test set all', () => {
    expect(common.all()(7)).toBeTruthy();
  });
});
...
describe('Test Add', () => {
  it('should test Add', () => {
    expect(core.contains(common.singleton(0), 7)).toBeFalsy();
    expect(core.add(common.singleton(0), 7)(7)).toBeTruthy();
    expect(core.add(common.singleton(1), 0)(0)).toBeTruthy();
    expect(core.add(common.singleton(19), 0)(7)).toBeFalsy();
  });
});
describe('Test Remove', () => {
  it('should test Remove', () => {
    expect(core.remove(common.singleton(0), 0)(7)).toBeFalsy();
    expect(core.remove(common.singleton(7), 7)(0)).toBeFalsy();
    expect(core.remove(common.all(), 0)(0)).toBeFalsy();
    expect(core.remove(common.all(), 0)(7)).toBeTruthy();
  });
});